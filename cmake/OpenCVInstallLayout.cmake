...
# [IGE]: modify below for conan packaging
# if(ANDROID)

  ocv_update(OPENCV_BIN_INSTALL_PATH            "bin}")
  ocv_update(OPENCV_TEST_INSTALL_PATH           "${OPENCV_BIN_INSTALL_PATH}")
  ocv_update(OPENCV_SAMPLES_BIN_INSTALL_PATH    "samples")
  ocv_update(OPENCV_LIB_INSTALL_PATH            "libs")
  ocv_update(OPENCV_LIB_ARCHIVE_INSTALL_PATH    "libs")
  ocv_update(OPENCV_3P_LIB_INSTALL_PATH         "libs")
